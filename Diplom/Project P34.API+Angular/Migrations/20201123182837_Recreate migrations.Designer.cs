...
namespace Project_P34.API_Angular.Migrations
{
    ...
    [Migration("20201123182837_Recreate migrations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Project_P34.DataAccess.Entity.Flat", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Project_P34.DataAccess.Entity.FlatSquareInfo", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("RoomsSquare")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("Id");

                    b.ToTable("tblFlatSquareInfo");
                });
            ...
            modelBuilder.Entity("Project_P34.DataAccess.Entity.Flat", b =>
                {
                    b.HasOne("Project_P34.DataAccess.Entity.FlatSquareInfo", "FlatSquareInfo")
                        .WithMany("Flats")
